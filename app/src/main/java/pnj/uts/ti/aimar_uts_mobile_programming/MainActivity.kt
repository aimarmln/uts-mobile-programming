package pnj.uts.ti.aimar_uts_mobile_programming
...
class MainActivity : AppCompatActivity() {
    ...
    private val HARDCODED_EMAIL = "aimar@gmail.com"
    private val HARDCODED_PASSWORD = "helloworld"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            if (TextUtils.isEmpty(email) || TextUtils.isEmpty(password)) {
                ...
                editor.putString("Nim", "2207411023")
                editor.putString("Nama", "Aimar Maulana")
